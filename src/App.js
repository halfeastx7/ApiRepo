...
const[color, setColor] = useState(colorpalette);
  return (
    <div>
        ...
        <ul class="list-group">
          <li href="#!" class="list-group-item list-group-item-action list-group-item-dark">ID: {used.id}</li>
          <li href="#!" class="list-group-item list-group-item-action list-group-item-warning">Color: {used.color}</li>
          <li chref="#!" class="list-group-item list-group-item-action list-group-item-warning">Hex Number: {used.hexnumber}</li>
        </ul>
          ))
        }
